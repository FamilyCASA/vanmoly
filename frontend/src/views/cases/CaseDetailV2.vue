<template>
  ...
  <div class="case-detail-v2">
    ...
    <div v-else-if="caseDetail" class="case-content">
        ...
        <div class="hero-content">
          ...
          <div class="hero-text">
            ...
            <div class="hero-attrs">
              ...
              <span v-if="caseDetail.atmosphere" class="attr-item">
                ...
                <span class="attr-icon">✦</span>{{ caseDetail.atmosphere }}
              ...
              <span v-if="caseDetail.style" class="attr-item">
                ...
                <span class="attr-icon">◈</span>{{ caseDetail.style }}
              ...
              <span v-if="caseDetail.house_type" class="attr-item">
                ...
                <span class="attr-icon">⌂</span>{{ caseDetail.house_type }}
              ...
              <span v-if="caseDetail.area" class="attr-item">
                ...
                <span class="attr-icon">□</span>{{ caseDetail.area }}㎡
            ...
            <div class="hero-palette" v-if="caseMainColors.length">
            ...
            <div class="hero-budget" v-if="caseDetail.deal_budget || caseDetail.total_price || caseDetail.quote_info">
              ...
              <span class="budget-label">
                ...
                {{ caseDetail.is_real_case ? '真实案例' : '参考造价' }}
              ...
              <span class="budget-value">¥{{ caseDetail.quote_info ? formatWan(caseDetail.quote_info.total_amount) : formatWan(caseDetail.deal_budget || caseDetail.total_price) }}</span>
            ...
            <div class="hero-team" v-if="serviceTeam.length">
              ...
              <div v-for="member in serviceTeam" :key="member.role" class="team-member">
                ...
                <img v-if="member.avatar" :src="member.avatar" class="team-avatar" />
                ...
                <div v-else class="team-avatar-placeholder">{{ member.name?.[0] }}</div>
      ...
      <section class="renderings-section">
        ...
        <h2 class="renderings-title">效果图展示</h2>
        ...
        <div class="renderings-waterfall" v-if="allRenderings.length">
          ...
          <div
            ...
            v-for="(img, idx) in allRenderings"
            ...
            @click="openImagePreview(idx, allRenderings)"
          ...
          >
            ...
            <span v-if="img._spaceName" class="space-label">{{ img._spaceName }}</span>
            ...
            <img :src="resolveImgUrl(img)" loading="lazy" />
        ...
        <el-empty v-else description="暂无效果图" />
...
const getAtmosphereGradient = (atm) => {
  ...
  return map[atm] || 'linear-gradient(135deg,#409EFF,#D4A574)'
...
const allRenderings = computed(() => {
  ...
  for (const s of spaces.value) {
    ...
    for (const item of items) {
      ...
      if (item.image_url) imgs.push({ ...item, _spaceName: spaceName })
  ...
  if (imgs.length === 0) {
    ...
    for (const m of galleryList.value) {
      ...
      if (m.url) imgs.push({ image_url: m.url, _spaceName: '' })
...
const caseMainColors = computed(() => {
  ...
  const colors = [...ensureArr(d.main_colors), ...ensureArr(d.auxiliary_colors), ...ensureArr(d.accent_colors)]
...
const serviceTeam = computed(() => {
  ...
  if (d.planner) team.push({ ...d.planner, role: '规划师' })
  ...
  if (d.designer) team.push({ ...d.designer, role: '设计师' })
...
.hero-gradient {
  ...
  -webkit-mask: linear-gradient(to top, black 0%, black 35%, rgba(0,0,0,0.3) 70%, transparent 100%);
  mask: linear-gradient(to top, black 0%, black 35%, rgba(0,0,0,0.3) 70%, transparent 100%);
}
...
.featured-badge {
  ...
  background: linear-gradient(135deg, #409EFF 0%, #a67c52 100%);
...
@media (max-width: 768px) {
  ...
  .attr-item { font-size: 12px; padding: 3px 8px; }



  .hero-palette { margin: 8px 0; }
  ...
  .hero-budget .budget-value { font-size: 18px; }



  .hero-team { flex-direction: column; gap: 10px; }



  .space-label { font-size: 10px; top: 4px; left: 4px; padding: 2px 6px; }
...
.progress-fill {
  ...
  background: linear-gradient(90deg, #409EFF, #d4a574);
...
.magazine-card {
  ...
  background: var(--img-color, #409EFF);
...
.sidebar-future-btn:hover:not(:disabled) {
