<template>
  ...
  <div class="home-page">
    ...
    <section class="process holo-dome-section">
      <div class="section-container">
    ...
    <!-- Brand Showcase 品牌背书 -->
    <section v-if="brandLogos.length > 0" class="brands-showcase">
      <div class="section-container">
        <div class="section-header">
...
.arrow-flow::after {
  ...
  border-left: 14px solid rgba(255,220,150,0.95);
